...
class LightGUI:
	...
	def resetEv(self,widget,data):
		...
		b = 0
		while b < self.k:
			self.lightImages[b].set_from_file("/home/rossjr/cs311project/onbulb.xpm")
			b = b + 1
	def safeLightEv(self,widget,data):
		if(self.canModifySwitchboard == False):
			print "redo-ing button press %s " % data
			self.lightImages[data].set_from_file("/home/rossjr/cs311project/offbulb.xpm")
			b=0
			while b < self.k:
	...
	def playModeEv(self,widget,data):
		...
		if(self.doesWork() == True):
			...
			image = gtk.Image()
			image.set_from_file("/home/rossjr/cs311project/no.png")
	...
	def __init__(self):
		...
		while b < self.k:
			a = gtk.Image()
			a.set_from_file("/home/rossjr/cs311project/onbulb.xpm")
			a.show()
